---
name: deployment-vercel-deployment
description: "Use this skill to work with GitHub to Vercel deploy behavior, production URLs, previews, aliases, and Vercel CLI safety."
---
...
Use this skill to work with GitHub to Vercel deploy behavior, production URLs, previews, aliases, and Vercel CLI safety.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/deployment/vercel-deployment.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that work with GitHub to Vercel deploy behavior, production URLs, previews, aliases, and Vercel CLI safety.
