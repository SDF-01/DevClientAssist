---
name: fullstack-notification-standard
description: "Use this skill to implement toasts, emails, in-app notifications, retries, templates, and failure paths consistently."
---

# Notification Standard Skill

## Purpose

Use this skill to implement toasts, emails, in-app notifications, retries, templates, and failure paths consistently.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/fullstack/notification-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that implement toasts, emails, in-app notifications, retries, templates, and failure paths consistently.

Also use it when the user manually invokes the skill by name:

```text
/fullstack-notification-standard
```
