---
name: testing-test-before-complete
description: "Use this skill to run applicable validation before completing tasks and document skipped checks."
---

# Test Before Complete Skill

## Purpose

Use this skill to run applicable validation before completing tasks and document skipped checks.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/testing/test-before-complete.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that run applicable validation before completing tasks and document skipped checks.

Also use it when the user manually invokes the skill by name:

```text
/testing-test-before-complete
```
