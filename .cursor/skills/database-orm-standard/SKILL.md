---
name: database-orm-standard
description: "Use this skill to use the project ORM consistently for schema, migrations, models, validation, and queries."
---
...
Use this skill to use the project ORM consistently for schema, migrations, models, validation, and queries.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/database/orm-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that use the project ORM consistently for schema, migrations, models, validation, and queries.
