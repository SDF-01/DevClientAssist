---
name: security-official-content-citation
description: "Use this skill to cite official sources for policy, training, legal, medical, military, or safety content."
---

# Official Content Citation Skill

## Purpose

Use this skill to cite official sources for policy, training, legal, medical, military, or safety content.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/security/official-content-citation.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that cite official sources for policy, training, legal, medical, military, or safety content.

Also use it when the user manually invokes the skill by name:

```text
/security-official-content-citation
```
