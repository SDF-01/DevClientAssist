---
name: frontend-responsive-design-standard
description: "Use this skill to verify mobile, tablet, desktop, and large-screen layouts with no overflow or unusable controls."
---

# Responsive Design Standard Skill

## Purpose

Use this skill to verify mobile, tablet, desktop, and large-screen layouts with no overflow or unusable controls.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/frontend/responsive-design-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that verify mobile, tablet, desktop, and large-screen layouts with no overflow or unusable controls.
