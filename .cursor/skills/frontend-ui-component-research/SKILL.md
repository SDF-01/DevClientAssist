---
name: frontend-ui-component-research
description: "Use this skill to research approved UI libraries and adapt patterns to the project design system before building interface elements."
---

# UI Component Research Skill

## Purpose

Use this skill to research approved UI libraries and adapt patterns to the project design system before building interface elements.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/frontend/ui-component-research.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that research approved UI libraries and adapt patterns to the project design system before building interface elements.

Also use it when the user manually invokes the skill by name:

```text
/frontend-ui-component-research
```
...
1. Search approved UI libraries or project references for the exact component pattern.
2. Reuse existing primitives before creating new components.
3. Adapt any reference implementation to project tokens, accessibility, and responsive layout.
4. Document the inspiration source in notes, PR text, or commit message.
5. Inspect existing components, routes, styles, tokens, and UI primitives.
6. Find the closest existing pattern before adding a new one.
7. Implement with typed props, semantic markup, accessible interactions, and responsive behavior.
8. Check loading, empty, error, success, hover, focus, and disabled states.
9. Run build, lint, typecheck, and component tests when available.
