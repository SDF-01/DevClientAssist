...
description: "Use this skill to update setup, scripts, env vars, architecture, deployment, and usage docs when behavior changes."
---
...
Use this skill to update setup, scripts, env vars, architecture, deployment, and usage docs when behavior changes.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/documentation/readme-update.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that update setup, scripts, env vars, architecture, deployment, and usage docs when behavior changes.
