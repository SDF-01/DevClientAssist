---
name: ai-agent-skill-trust-rule
description: "Use this skill to review third-party or generated skills for unsafe instructions before use."
---

# Agent Skill Trust Rule Skill

## Purpose

Use this skill to review third-party or generated skills for unsafe instructions before use.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/ai/agent-skill-trust-rule.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that review third-party or generated skills for unsafe instructions before use.

Also use it when the user manually invokes the skill by name:

```text
/ai-agent-skill-trust-rule
```
