---
name: project-profile-fastapi-backend-profile
description: "Use this skill to apply API service conventions for FastAPI applications."
---

# FastAPI Backend Profile Skill

## Purpose

Use this skill to apply API service conventions for FastAPI applications.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/project-profile/fastapi-backend-profile.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that apply API service conventions for FastAPI applications.

Also use it when the user manually invokes the skill by name:

```text
/project-profile-fastapi-backend-profile
```
