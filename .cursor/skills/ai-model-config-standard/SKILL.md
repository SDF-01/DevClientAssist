---
name: ai-model-config-standard
description: "Use this skill to centralize model names, providers, temperature, limits, retries, and fallback behavior."
---

# Model Config Standard Skill

## Purpose

Use this skill to centralize model names, providers, temperature, limits, retries, and fallback behavior.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/ai/model-config-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that centralize model names, providers, temperature, limits, retries, and fallback behavior.

Also use it when the user manually invokes the skill by name:

```text
/ai-model-config-standard
```
