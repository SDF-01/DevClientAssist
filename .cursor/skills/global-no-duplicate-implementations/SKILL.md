---
name: global-no-duplicate-implementations
description: "Use this skill to find existing utilities, components, routes, services, and patterns before creating new versions."
---

# No Duplicate Implementations Skill

## Purpose

Use this skill to find existing utilities, components, routes, services, and patterns before creating new versions.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/global/no-duplicate-implementations.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that find existing utilities, components, routes, services, and patterns before creating new versions.

Also use it when the user manually invokes the skill by name:

```text
/global-no-duplicate-implementations
```
