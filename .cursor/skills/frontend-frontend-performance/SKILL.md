...
description: "Use this skill to reduce bundle bloat, avoid wasteful renders, optimize media, and protect interaction speed."
---
...
Use this skill to reduce bundle bloat, avoid wasteful renders, optimize media, and protect interaction speed.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/frontend/frontend-performance.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that reduce bundle bloat, avoid wasteful renders, optimize media, and protect interaction speed.
