...
description: "Use this skill to work with GitHub to Netlify deploy behavior, production URLs, deploy contexts, and CLI safety."
---
...
Use this skill to work with GitHub to Netlify deploy behavior, production URLs, deploy contexts, and CLI safety.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/deployment/netlify-deployment.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that work with GitHub to Netlify deploy behavior, production URLs, deploy contexts, and CLI safety.
