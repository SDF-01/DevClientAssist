---
name: security-no-operational-guessing
description: "Use this skill to avoid inventing procedures, authorities, safety guidance, or operational facts when source data is missing."
---

# No Operational Guessing Skill

## Purpose

Use this skill to avoid inventing procedures, authorities, safety guidance, or operational facts when source data is missing.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/security/no-operational-guessing.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that avoid inventing procedures, authorities, safety guidance, or operational facts when source data is missing.

Also use it when the user manually invokes the skill by name:

```text
/security-no-operational-guessing
```
