---
name: security-data-classification-banner
description: "Use this skill to apply visible handling labels and banners when a project needs classification or sensitivity markers."
---

# Data Classification Banner Skill

## Purpose

Use this skill to apply visible handling labels and banners when a project needs classification or sensitivity markers.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/security/data-classification-banner.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that apply visible handling labels and banners when a project needs classification or sensitivity markers.

Also use it when the user manually invokes the skill by name:

```text
/security-data-classification-banner
```
