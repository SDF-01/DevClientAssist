---
name: backend-error-handling-standard
description: "Use this skill to return useful errors, log meaningful context, avoid leaking internals, and prevent silent failures."
---

# Backend Error Handling Standard Skill

## Purpose

Use this skill to return useful errors, log meaningful context, avoid leaking internals, and prevent silent failures.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/backend/error-handling-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that return useful errors, log meaningful context, avoid leaking internals, and prevent silent failures.
