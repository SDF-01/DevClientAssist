---
name: backend-api-contract-standard
description: "Use this skill to define stable request, response, validation, authentication, and error contracts for endpoints."
---

# API Contract Standard Skill

## Purpose

Use this skill to define stable request, response, validation, authentication, and error contracts for endpoints.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/backend/api-contract-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that define stable request, response, validation, authentication, and error contracts for endpoints.
