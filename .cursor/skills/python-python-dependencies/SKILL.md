---
name: python-python-dependencies
description: "Use this skill to manage Python dependencies, virtual environments, lockfiles, and package metadata safely."
---

# Python Dependencies Skill

## Purpose

Use this skill to manage Python dependencies, virtual environments, lockfiles, and package metadata safely.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/python/python-dependencies.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that manage Python dependencies, virtual environments, lockfiles, and package metadata safely.
