---
name: testing-test-data-safety
description: "Use this skill to use deterministic safe fixtures without real PII, secrets, or operational data."
---

# Test Data Safety Skill

## Purpose

Use this skill to use deterministic safe fixtures without real PII, secrets, or operational data.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/testing/test-data-safety.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that use deterministic safe fixtures without real PII, secrets, or operational data.

Also use it when the user manually invokes the skill by name:

```text
/testing-test-data-safety
```
