---
name: security-training-simulator-safety
description: "Use this skill to separate training simulation from real-world instruction and protect learners from unsafe ambiguity."
---

# Training Simulator Safety Skill

## Purpose

Use this skill to separate training simulation from real-world instruction and protect learners from unsafe ambiguity.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/security/training-simulator-safety.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that separate training simulation from real-world instruction and protect learners from unsafe ambiguity.

Also use it when the user manually invokes the skill by name:

```text
/security-training-simulator-safety
```
