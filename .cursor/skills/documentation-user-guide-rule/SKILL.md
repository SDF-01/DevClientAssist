---
name: documentation-user-guide-rule
description: "Use this skill to write task-focused user help for onboarding, workflows, common errors, and screenshots when needed."
---

# User Guide Rule Skill

## Purpose

Use this skill to write task-focused user help for onboarding, workflows, common errors, and screenshots when needed.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/documentation/user-guide-rule.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that write task-focused user help for onboarding, workflows, common errors, and screenshots when needed.

Also use it when the user manually invokes the skill by name:

```text
/documentation-user-guide-rule
```
