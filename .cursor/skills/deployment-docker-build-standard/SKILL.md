---
name: deployment-docker-build-standard
description: "Use this skill to create and update Dockerfiles, compose files, build contexts, health checks, and image safety."
---

# Docker Build Standard Skill

## Purpose

Use this skill to create and update Dockerfiles, compose files, build contexts, health checks, and image safety.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/deployment/docker-build-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that create and update Dockerfiles, compose files, build contexts, health checks, and image safety.

Also use it when the user manually invokes the skill by name:

```text
/deployment-docker-build-standard
```
