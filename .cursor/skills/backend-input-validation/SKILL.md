...
description: "Use this skill to validate external input at boundaries using schemas, types, limits, and normalization."
---
...
Use this skill to validate external input at boundaries using schemas, types, limits, and normalization.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/backend/input-validation.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that validate external input at boundaries using schemas, types, limits, and normalization.
