---
name: frontend-motion-standards
description: "Use this skill to use animation only when it improves clarity, feedback, hierarchy, or flow."
---
...
Use this skill to use animation only when it improves clarity, feedback, hierarchy, or flow.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/frontend/motion-standards.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that use animation only when it improves clarity, feedback, hierarchy, or flow.

Also use it when the user manually invokes the skill by name:

```text
/frontend-motion-standards
```
