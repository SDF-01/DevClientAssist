---
name: security-rbac-standard
description: "Use this skill to design and enforce roles, permissions, policy checks, ownership, and admin boundaries."
---
...
Use this skill to design and enforce roles, permissions, policy checks, ownership, and admin boundaries.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/security/rbac-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that design and enforce roles, permissions, policy checks, ownership, and admin boundaries.
