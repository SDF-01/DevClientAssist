---
name: backend-api-docs-update
description: "Use this skill to update endpoint documentation when API contracts, auth, errors, or examples change."
---

# API Docs Update Skill

## Purpose

Use this skill to update endpoint documentation when API contracts, auth, errors, or examples change.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/backend/api-docs-update.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that update endpoint documentation when API contracts, auth, errors, or examples change.
