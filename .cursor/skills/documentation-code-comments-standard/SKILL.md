---
name: documentation-code-comments-standard
description: "Use this skill to write comments that explain why, constraints, and non-obvious behavior without clutter."
---

# Code Comments Standard Skill

## Purpose

Use this skill to write comments that explain why, constraints, and non-obvious behavior without clutter.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/documentation/code-comments-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that write comments that explain why, constraints, and non-obvious behavior without clutter.

Also use it when the user manually invokes the skill by name:

```text
/documentation-code-comments-standard
```
