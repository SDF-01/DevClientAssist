---
name: fullstack-auth-flow-standard
description: "Use this skill to build login, logout, sessions, roles, redirects, guards, and secure server checks."
---

# Auth Flow Standard Skill

## Purpose

Use this skill to build login, logout, sessions, roles, redirects, guards, and secure server checks.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/fullstack/auth-flow-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that build login, logout, sessions, roles, redirects, guards, and secure server checks.

Also use it when the user manually invokes the skill by name:

```text
/fullstack-auth-flow-standard
```
