---
name: testing-unit-test-standard
description: "Use this skill to write fast deterministic unit tests for pure logic, helpers, services, and edge cases."
---

# Unit Test Standard Skill

## Purpose

Use this skill to write fast deterministic unit tests for pure logic, helpers, services, and edge cases.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/testing/unit-test-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that write fast deterministic unit tests for pure logic, helpers, services, and edge cases.

Also use it when the user manually invokes the skill by name:

```text
/testing-unit-test-standard
```
