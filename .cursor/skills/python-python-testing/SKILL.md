---
name: python-python-testing
description: "Use this skill to write and run pytest coverage for units, integrations, fixtures, edge cases, and regressions."
---
...
Use this skill to write and run pytest coverage for units, integrations, fixtures, edge cases, and regressions.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/python/python-testing.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that write and run pytest coverage for units, integrations, fixtures, edge cases, and regressions.
