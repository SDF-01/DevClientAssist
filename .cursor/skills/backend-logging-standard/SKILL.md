...
description: "Use this skill to write structured, useful logs without secrets or noisy spam."
---

# Backend Logging Standard Skill

## Purpose

Use this skill to write structured, useful logs without secrets or noisy spam.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/backend/logging-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that write structured, useful logs without secrets or noisy spam.
