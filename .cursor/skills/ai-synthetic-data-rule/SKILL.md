---
name: ai-synthetic-data-rule
description: "Use this skill to label synthetic data, avoid real PII, and maintain clear generation assumptions."
---

# Synthetic Data Rule Skill

## Purpose

Use this skill to label synthetic data, avoid real PII, and maintain clear generation assumptions.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/ai/synthetic-data-rule.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that label synthetic data, avoid real PII, and maintain clear generation assumptions.

Also use it when the user manually invokes the skill by name:

```text
/ai-synthetic-data-rule
```
