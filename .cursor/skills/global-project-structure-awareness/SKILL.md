---
name: global-project-structure-awareness
description: "Use this skill to inspect the existing repository layout, naming conventions, routing model, and architectural boundaries before creating or moving files."
---

# Project Structure Awareness Skill

## Purpose

Use this skill to inspect the existing repository layout, naming conventions, routing model, and architectural boundaries before creating or moving files.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/global/project-structure-awareness.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that inspect the existing repository layout, naming conventions, routing model, and architectural boundaries before creating or moving files.

Also use it when the user manually invokes the skill by name:

```text
/global-project-structure-awareness
```
