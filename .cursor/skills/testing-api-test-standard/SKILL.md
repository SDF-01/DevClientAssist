---
name: testing-api-test-standard
description: "Use this skill to test API success, failure, auth, validation, rate limits, and data behavior."
---

# API Test Standard Skill

## Purpose

Use this skill to test API success, failure, auth, validation, rate limits, and data behavior.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/testing/api-test-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that test API success, failure, auth, validation, rate limits, and data behavior.

Also use it when the user manually invokes the skill by name:

```text
/testing-api-test-standard
```
