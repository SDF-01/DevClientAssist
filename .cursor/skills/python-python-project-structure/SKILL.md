---
name: python-python-project-structure
description: "Use this skill to organize Python applications with clear packages, entry points, config, tests, and docs."
---
...
Use this skill to organize Python applications with clear packages, entry points, config, tests, and docs.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/python/python-project-structure.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that organize Python applications with clear packages, entry points, config, tests, and docs.
