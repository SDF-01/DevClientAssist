---
name: python-python-error-handling
description: "Use this skill to handle exceptions clearly, preserve traceability, and avoid swallowed failures."
---
...
Use this skill to handle exceptions clearly, preserve traceability, and avoid swallowed failures.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/python/python-error-handling.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that handle exceptions clearly, preserve traceability, and avoid swallowed failures.
