---
name: backend-server-action-safety
description: "Use this skill to secure server actions, mutations, revalidation, redirects, and privileged operations."
---

# Server Action Safety Skill

## Purpose

Use this skill to secure server actions, mutations, revalidation, redirects, and privileged operations.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/backend/server-action-safety.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that secure server actions, mutations, revalidation, redirects, and privileged operations.

Also use it when the user manually invokes the skill by name:

```text
/backend-server-action-safety
```
