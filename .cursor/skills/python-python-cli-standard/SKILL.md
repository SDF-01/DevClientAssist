---
name: python-python-cli-standard
description: "Use this skill to create predictable command line interfaces with help text, exit codes, config, and errors."
---

# Python CLI Standard Skill

## Purpose

Use this skill to create predictable command line interfaces with help text, exit codes, config, and errors.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/python/python-cli-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that create predictable command line interfaces with help text, exit codes, config, and errors.

Also use it when the user manually invokes the skill by name:

```text
/python-python-cli-standard
```
