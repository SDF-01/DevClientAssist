---
name: testing-e2e-test-standard
description: "Use this skill to test important user flows with Playwright, Cypress, or project tooling."
---

# E2E Test Standard Skill

## Purpose

Use this skill to test important user flows with Playwright, Cypress, or project tooling.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/testing/e2e-test-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that test important user flows with Playwright, Cypress, or project tooling.

Also use it when the user manually invokes the skill by name:

```text
/testing-e2e-test-standard
```
