...
description: "Use this skill to implement forms with validation, errors, labels, accessibility, and safe submit behavior."
---
...
Use this skill to implement forms with validation, errors, labels, accessibility, and safe submit behavior.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/frontend/forms-validation.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that implement forms with validation, errors, labels, accessibility, and safe submit behavior.
