...
description: "Use this skill to build small, composable, typed, maintainable components that fit the existing frontend structure."
---
...
Use this skill to build small, composable, typed, maintainable components that fit the existing frontend structure.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/frontend/component-architecture.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that build small, composable, typed, maintainable components that fit the existing frontend structure.
