---
name: deployment-git-hygiene
description: "Use this skill to inspect, stage, commit, and push changes safely with useful commit messages and no unrelated files."
---
...
Use this skill to inspect, stage, commit, and push changes safely with useful commit messages and no unrelated files.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/deployment/git-hygiene.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that inspect, stage, commit, and push changes safely with useful commit messages and no unrelated files.

Also use it when the user manually invokes the skill by name:

```text
/deployment-git-hygiene
```
