---
name: project-profile-nextjs-saas-profile
description: "Use this skill to apply SaaS conventions for Next.js apps with auth, billing, dashboard, API, and deployment."
---

# Next.js SaaS Profile Skill

## Purpose

Use this skill to apply SaaS conventions for Next.js apps with auth, billing, dashboard, API, and deployment.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/project-profile/nextjs-saas-profile.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that apply SaaS conventions for Next.js apps with auth, billing, dashboard, API, and deployment.

Also use it when the user manually invokes the skill by name:

```text
/project-profile-nextjs-saas-profile
```
