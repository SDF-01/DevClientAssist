---
name: deployment-production-safety
description: "Use this skill to protect production config, data, URLs, branches, migrations, and deployment operations."
---
...
Use this skill to protect production config, data, URLs, branches, migrations, and deployment operations.
...
Use this skill when the user request, changed files, or related rule indicates that protect production config, data, URLs, branches, migrations, and deployment operations.
