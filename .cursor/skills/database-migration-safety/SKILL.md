...
description: "Use this skill to plan, review, and run schema migrations without accidental data loss."
---
...
Use this skill to plan, review, and run schema migrations without accidental data loss.
...
Use this skill when the user request, changed files, or related rule indicates that plan, review, and run schema migrations without accidental data loss.
