---
name: documentation-adr-rule
description: "Use this skill to capture significant architecture choices, tradeoffs, consequences, and alternatives."
---
...
Use this skill to capture significant architecture choices, tradeoffs, consequences, and alternatives.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/documentation/adr-rule.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that capture significant architecture choices, tradeoffs, consequences, and alternatives.

Also use it when the user manually invokes the skill by name:

```text
/documentation-adr-rule
```
