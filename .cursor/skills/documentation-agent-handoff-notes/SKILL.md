---
name: documentation-agent-handoff-notes
description: "Use this skill to leave concise notes about what changed, what was verified, and what remains."
---

# Agent Handoff Notes Skill

## Purpose

Use this skill to leave concise notes about what changed, what was verified, and what remains.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/documentation/agent-handoff-notes.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that leave concise notes about what changed, what was verified, and what remains.

Also use it when the user manually invokes the skill by name:

```text
/documentation-agent-handoff-notes
```
