...
description: "Use this skill to choose local, derived, server, or global state deliberately and avoid unnecessary complexity."
---
...
Use this skill to choose local, derived, server, or global state deliberately and avoid unnecessary complexity.
...
Use this skill when the user request, changed files, or related rule indicates that choose local, derived, server, or global state deliberately and avoid unnecessary complexity.
