---
name: fullstack-file-upload-standard
description: "Use this skill to validate, scan, limit, store, and serve uploaded files safely."
---

# File Upload Standard Skill

## Purpose

Use this skill to validate, scan, limit, store, and serve uploaded files safely.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/fullstack/file-upload-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that validate, scan, limit, store, and serve uploaded files safely.

Also use it when the user manually invokes the skill by name:

```text
/fullstack-file-upload-standard
```
