---
name: fullstack-environment-config-standard
description: "Use this skill to define and validate environment variables, examples, runtime config, and secret boundaries."
---

# Environment Config Standard Skill

## Purpose

Use this skill to define and validate environment variables, examples, runtime config, and secret boundaries.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/fullstack/environment-config-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that define and validate environment variables, examples, runtime config, and secret boundaries.

Also use it when the user manually invokes the skill by name:

```text
/fullstack-environment-config-standard
```
