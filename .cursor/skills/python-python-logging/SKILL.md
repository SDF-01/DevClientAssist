---
name: python-python-logging
description: "Use this skill to replace debug print spam with structured logging and safe log context."
---
...
Use this skill to replace debug print spam with structured logging and safe log context.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/python/python-logging.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that replace debug print spam with structured logging and safe log context.
