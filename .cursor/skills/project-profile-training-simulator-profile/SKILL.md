---
name: project-profile-training-simulator-profile
description: "Use this skill to apply conventions for simulation games, training flows, scenarios, scoring, and after-action review."
---

# Training Simulator Profile Skill

## Purpose

Use this skill to apply conventions for simulation games, training flows, scenarios, scoring, and after-action review.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/project-profile/training-simulator-profile.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that apply conventions for simulation games, training flows, scenarios, scoring, and after-action review.

Also use it when the user manually invokes the skill by name:

```text
/project-profile-training-simulator-profile
```
