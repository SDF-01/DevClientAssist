---
name: security-no-destructive-commands
description: "Use this skill to prevent unsafe shell, git, database, filesystem, and cloud operations unless the user explicitly approves the risk."
---

# No Destructive Commands Skill

## Purpose

Use this skill to prevent unsafe shell, git, database, filesystem, and cloud operations unless the user explicitly approves the risk.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/security/no-destructive-commands.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that prevent unsafe shell, git, database, filesystem, and cloud operations unless the user explicitly approves the risk.
