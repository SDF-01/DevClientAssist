---
name: fullstack-admin-dashboard-standard
description: "Use this skill to create secure admin interfaces with tables, filters, audit actions, roles, and safe mutations."
---

# Admin Dashboard Standard Skill

## Purpose

Use this skill to create secure admin interfaces with tables, filters, audit actions, roles, and safe mutations.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/fullstack/admin-dashboard-standard.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that create secure admin interfaces with tables, filters, audit actions, roles, and safe mutations.

Also use it when the user manually invokes the skill by name:

```text
/fullstack-admin-dashboard-standard
```
