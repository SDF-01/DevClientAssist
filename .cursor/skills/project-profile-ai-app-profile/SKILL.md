---
name: project-profile-ai-app-profile
description: "Use this skill to apply project conventions for AI, RAG, agentic, and model-powered applications."
---

# AI App Profile Skill

## Purpose

Use this skill to apply project conventions for AI, RAG, agentic, and model-powered applications.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/project-profile/ai-app-profile.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that apply project conventions for AI, RAG, agentic, and model-powered applications.

Also use it when the user manually invokes the skill by name:

```text
/project-profile-ai-app-profile
```
