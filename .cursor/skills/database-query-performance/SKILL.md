...
description: "Use this skill to prevent N plus 1 queries, unbounded reads, missing indexes, and expensive operations."
---
...
Use this skill to prevent N plus 1 queries, unbounded reads, missing indexes, and expensive operations.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/database/query-performance.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that prevent N plus 1 queries, unbounded reads, missing indexes, and expensive operations.
