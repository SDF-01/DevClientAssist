---
name: ai-ai-output-safety
description: "Use this skill to ground AI responses, state uncertainty, avoid hallucinated certainty, and refuse unsafe outputs."
---

# AI Output Safety Skill

## Purpose

Use this skill to ground AI responses, state uncertainty, avoid hallucinated certainty, and refuse unsafe outputs.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/ai/ai-output-safety.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that ground AI responses, state uncertainty, avoid hallucinated certainty, and refuse unsafe outputs.
