---
name: project-profile-python-cli-profile
description: "Use this skill to apply project conventions for Python command line tools."
---

# Python CLI Profile Skill

## Purpose

Use this skill to apply project conventions for Python command line tools.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/project-profile/python-cli-profile.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that apply project conventions for Python command line tools.

Also use it when the user manually invokes the skill by name:

```text
/project-profile-python-cli-profile
```
