---
name: project-profile-dashboard-app-profile
description: "Use this skill to apply conventions for data-heavy dashboards, admin views, charts, filters, and tables."
---

# Dashboard App Profile Skill

## Purpose

Use this skill to apply conventions for data-heavy dashboards, admin views, charts, filters, and tables.

This skill is the operational workflow that supports the related Cursor rule:

```text
.cursor/rules/project-profile/dashboard-app-profile.mdc
```
...
Use this skill when the user request, changed files, or related rule indicates that apply conventions for data-heavy dashboards, admin views, charts, filters, and tables.

Also use it when the user manually invokes the skill by name:

```text
/project-profile-dashboard-app-profile
```
